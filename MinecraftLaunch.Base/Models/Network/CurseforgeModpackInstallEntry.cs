...
public record CurseforgeModpackInstallEntry {
    ...
    [JsonPropertyName("minecraft")] public ModpackMinecraftEntry Minecraft { get; set; }
    [JsonPropertyName("files")] public IEnumerable<ModpackFileEntry> ModFiles { get; set; }
...
public record ModpackMinecraftEntry {
...
public record ModpackFileEntry {
